        ...
        "contents": [
          {
            ...
            "contents": [
              ...
              {
                "type": "text",
                "text": "部室の予約が出来ます。日付、時限、バンド名をカンマで区切って入力してください。日付部分は半角数字をスラッシュで区切って入力してください。「今日」も使えます。",
                "wrap": true,
                "size": "md",
                "margin": "md",
                "color": "#777777"
          ...
          },
          {
            ...
            "contents": [
              ...
              {
                "type": "text",
                "text": "部室ちゃんを使って入れた予約は、部室ちゃんの予約取り消し機能で消すことが可能です。日付、時限を入力してください。なお、LINEのアカウントと予約が紐付いているので予約者にしかキャンセルが出来ません。",
                "wrap": true,
                "size": "md",
                "margin": "md",
                "color": "#777777"
          ...
          },
          {
            ...
            "contents": [
              ...
              {
                "type": "text",
                "text": "何か動作におかしな事があればエラー報告をしてくれればシートに記録されます。作った人がぼちぼち見て修正します。",
                "wrap": true,
                "size": "md",
                "margin": "xs",
                "color": "#777777"
